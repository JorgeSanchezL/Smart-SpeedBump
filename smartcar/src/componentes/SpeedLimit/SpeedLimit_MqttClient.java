...
public abstract class SpeedLimit_MqttClient implements MqttCallback {

	protected MqttClient myClient;
	protected String clientId = null;
	protected String brokerURL = null;

	protected SpeedLimit speedLimit = null;

	
	public SpeedLimit_MqttClient(String clientId, SpeedLimit speedLimit, String MQTTBrokerURL) {
